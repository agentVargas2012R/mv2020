    ...
    this.caseStudyPanels = [
      {
          ...
          "heading"   :     "The Goals",
          "icon"         :    "fas fa-check pad-right landscape",
          "icon2"         :    "fas fa-bullseye fa-5x portrait",
          "bullet1"     :    "Educate:",
      ...
      },
      {
        ...
        "icon"         :    "fas fa-check landscape",
        "icon2"         :    "fas fa-directions fa-5x portrait",
        "bullet1"     :    "Terminology:",
      ...
      },
      {
        ...
        "heading"   :     "The Result",
        "icon"         :    "fas fa-check landscape",
        "icon2"        :    "fas fa-poll-h fa-5x portrait",
        "bullet1"     :    "Savings:",
